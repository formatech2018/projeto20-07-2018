		...
		<table class="table">
			...
			<tbody>
				<tr>
					...
					<td><?php if( $status == 0 ){ ?> <a href="/crud/emprestimo/<?php echo htmlspecialchars( $idusuario, ENT_COMPAT, 'UTF-8', FALSE ); ?>/usuario/funcionario/detalhes">Indisponível</a> <?php }else{ ?> Disponível <?php } ?></td>
